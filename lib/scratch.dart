...
import 'package:sp_tastebud/shared/checkbox_card/bloc/checkbox_card_bloc.dart';
...
class _UserProfileState extends State<UserProfile> {
  ...
  void _onSelectionsChanged(List<bool> newSelections) {
    setState(() {});
  }
                      ...
                      if (userProfileState is UserProfileLoaded) {
                        ...
                        return MultiBlocProvider(
                          providers: [
                            ...
                            BlocProvider<CheckboxCardBloc>(
                              create: (context) =>
                                  GetIt.instance<CheckboxCardBloc>(
                                      param1: mapOptionsToBoolean(
